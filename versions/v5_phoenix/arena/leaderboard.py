...
Reads every ArenaResult JSON from `versions/v5_phoenix/experiments/arena/*.json`,
...
# From versions/v3_arcadia/results/R6_EUCLIDIAN.json (10,800-episode benchmark).
...
BASELINES = [
    {"policy_name": "MaskablePPO-v3 (ours)", "submitted_at": "2026-04-18T00:00:00Z",
     ...
     "source": "versions/v3_arcadia/results/R6_EUCLIDIAN.json (3 tasks x 900 eps)"},
    {"policy_name": "RecurrentPPO-v3", "submitted_at": "2026-04-18T00:00:00Z",
     ...
     "source": "versions/v3_arcadia/results/R6_ALGO_COMPARISON.json (easy only)"},
