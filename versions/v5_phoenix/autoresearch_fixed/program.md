...
`versions/v4_arcadia_live/autoresearch/candidate_train.py`
...
1. **Repo is one-shot runnable**: `python -m versions.v4_arcadia_live.autoresearch.orchestrator --budget 6h` kicks off the full overnight loop.
...
From `versions/v3_arcadia/results/R6_EUCLIDIAN.json`:
