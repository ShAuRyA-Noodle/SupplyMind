...
RECEIPTS_DIR = PROJECT_ROOT / "versions/v4_arcadia_live" / "receipts"
...
RECEIPT_SPECS: list[dict] = [
    {
        ...
        "command": _jqlike("versions/v3_arcadia/results/R5_GRANITE.json", ".pipelines.P2_mxbai_bi.p1"),
        "data_files": ["versions/v3_arcadia/results/R5_GRANITE.json"],
    },
    {
        "number_id": "R5_GRANITE_mxbai_MRR",
        "description": "RAG MRR on precise queries",
        "command": _jqlike("versions/v3_arcadia/results/R5_GRANITE.json", ".pipelines.P2_mxbai_bi.mrr"),
        "data_files": ["versions/v3_arcadia/results/R5_GRANITE.json"],
    },
    {
        "number_id": "R5_BEIR_snowflake_nDCG10",
        "description": "BEIR out-of-domain nDCG@10 (Snowflake) on 26 Wiki crisis articles",
        "command": _jqlike("versions/v3_arcadia/results/R5_BEIR_MANUAL.json",
                           '.our_results."snowflake-arctic-l"."mean_ndcg@10"'),
        "data_files": ["versions/v3_arcadia/results/R5_BEIR_MANUAL.json"],
    },
    {
        "number_id": "R4_2JUDGE_Krippendorff_alpha",
        "description": "2-judge panel Krippendorff ordinal alpha on 26 crisis scenarios",
        "command": _jqlike("versions/v3_arcadia/results/R4_DANGEROUS_V2_ABLATION.json",
                           ".agreement_primary_panel.krippendorff_alpha_ordinal"),
        "data_files": ["versions/v3_arcadia/results/R4_DANGEROUS_V2_ABLATION.json"],
    },
    {
    ...
    },
    {
        ...
        "command": _jqlike("versions/v3_arcadia/results/R6_GETHSEMANE_MASKING_ABLATION.json",
                           ".action_masking_contribution.reward_pct_delta"),
        "data_files": ["versions/v3_arcadia/results/R6_GETHSEMANE_MASKING_ABLATION.json"],
    },
    {
        "number_id": "R6_GCN_easy_MAE_vs_MLP",
        "description": "GNN easy-graph MAE reduction vs MLP baseline (%)",
        "command": _jqlike("versions/v3_arcadia/results/R6_PROVIDER_V2.json",
                           ".graphs.easy.improvement_vs_mlp_pct"),
        "data_files": ["versions/v3_arcadia/results/R6_PROVIDER_V2.json"],
    },
    {
        "number_id": "R6_AquaRegia_WTI_dev95",
        "description": "Per-horizon conformal deviation at 95% nominal, WTI ARIMA",
        "command": ("python -c \"import json; d=json.load(open('versions/v3_arcadia/results/R6_AQUA_REGIA_V2.json'));"
                    "c=d['results']['DCOILWTICO']['arima']['conf=0.95'];"
                    "print(abs(c['perhorizon_coverage_mean']-c['nominal_coverage']))\""),
        "data_files": ["versions/v3_arcadia/results/R6_AQUA_REGIA_V2.json"],
    },
    {
        "number_id": "R3_TimesFM_CP_WTI_dev95",
        "description": "TimesFM-CP WTI deviation from 95% nominal",
        "command": ("python -c \"import json; d=json.load(open('versions/v3_arcadia/results/R3_TIMESFM_QUANTILE.json'));"
                    "print(d['targets']['DCOILWTICO']['timesfm_conf=0.95']['dev_from_nominal'])\""),
        "data_files": ["versions/v3_arcadia/results/R3_TIMESFM_QUANTILE.json"],
    },
    {
        "number_id": "V4_SPOF_V2_F1",
        "description": "v4 SPOF articulation-point F1 (mean across 3 graphs)",
        "command": _jqlike("versions/v4_arcadia_live/features/R6_SPOF_V2.json",
                           ".summary.v2_mean_f1"),
        "data_files": ["versions/v4_arcadia_live/features/R6_SPOF_V2.json"],
    },
    {
        "number_id": "V4_STACKING_V2_lift_vs_WV",
        "description": "v4 Stacking v2 AUC lift vs ensemble weighted voting",
        "command": _jqlike("versions/v4_arcadia_live/features/R15_STACKING_V2.json",
                           ".lift_stacking_vs_wv_auc"),
        "data_files": ["versions/v4_arcadia_live/features/R15_STACKING_V2.json"],
    },
    {
        "number_id": "V4_Live_Brent_202604",
        "description": "FRED Brent crude spot price as ingested on 2026-04-21 ($/bbl)",
        "command": ("python -c \"import sqlite3, json; c=sqlite3.connect('versions/v4_arcadia_live/realtime/events.db');"
        ...
        "data_files": ["versions/v4_arcadia_live/realtime/events.db"],
    },
    {
        "number_id": "V4_Tests_Total",
        "description": "Total test count across v3 + v4",
        "command": ("python -m pytest tests/ versions/v4_arcadia_live/tests/ "
                    "--collect-only -q"),
        "data_files": [],
    },
    {
        ...
        "command": _jqlike("versions/v4_arcadia_live/features/R9_ANALYST_AB_V5.json",
                           ".summary.exact_acc_lift"),
        "data_files": ["versions/v4_arcadia_live/features/R9_ANALYST_AB_V5.json"],
    },
    {
        "number_id": "V4_Autoresearch_Best_CI95",
        "description": "Best CI95-lower accepted by autoresearch orchestrator (bootstrap 1000)",
        "command": ("python -c \"import json; d=json.load(open('versions/v4_arcadia_live/autoresearch/state.json'));"
                    "print(d['best']['metric']['ci95_lower']) if d.get('best') else print('none')\""),
        "data_files": ["versions/v4_arcadia_live/autoresearch/state.json"],
    },
]
