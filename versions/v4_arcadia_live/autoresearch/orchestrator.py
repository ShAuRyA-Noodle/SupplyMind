...
Usage:
    ...
    python -m versions.v4_arcadia_live.autoresearch.orchestrator --agent claude --budget 12h
    touch versions/v4_arcadia_live/autoresearch/stop_autoresearch.flag  # graceful halt
"""
