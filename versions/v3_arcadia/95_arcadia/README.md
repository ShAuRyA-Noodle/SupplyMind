...
# 3. Run any phase
python versions/v3_arcadia/20_past_self/train_past_self.py   # R3
python versions/v3_arcadia/30_dangerous/r4_v2_beast.py       # R4
python versions/v3_arcadia/40_granite/r5_rag_beast.py        # R5
python versions/v3_arcadia/50_gethsemane/train_rl_beast.py   # R6 RL
python versions/v3_arcadia/70_provider/r6_gnn.py             # R6 GNN
python versions/v3_arcadia/80_aqua_regia/r6_conformal.py     # R6 conformal
python versions/v3_arcadia/60_euclidian/r6_massive_benchmark.py  # R6 benchmark
