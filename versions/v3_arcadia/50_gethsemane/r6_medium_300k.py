...
Output:
  versions/v3_arcadia/results/R6_GETHSEMANE_MEDIUM_300K.json
  versions/v3_arcadia/checkpoints/gethsemane/ppo_medium_multi_front_300k.zip
  versions/v3_arcadia/checkpoints/gethsemane/ppo_medium_multi_front_300k_UNMASKED.zip
"""
