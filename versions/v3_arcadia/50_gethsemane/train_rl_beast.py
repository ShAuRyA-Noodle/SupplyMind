...
Outputs:
  versions/v3_arcadia/checkpoints/gethsemane/ppo_<task>.zip
  versions/v3_arcadia/results/R6_GETHSEMANE.json
  versions/v3_arcadia/plots/gethsemane/training_curves.png
"""
