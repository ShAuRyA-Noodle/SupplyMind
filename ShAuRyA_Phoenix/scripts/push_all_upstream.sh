...
gh pr create --repo meta-pytorch/openenv \
  ...
  --body-file "$HOME/Desktop/Sleep-Token/ShAuRyA_Phoenix/upstream_prs/meta_openenv/PR.md" \
  2>&1 | tail -3
...
gh pr create --repo alibaba/ROLL \
  ...
  --body-file "$HOME/Desktop/Sleep-Token/ShAuRyA_Phoenix/upstream_prs/alibaba_roll/PR.md" \
  2>&1 | tail -3
