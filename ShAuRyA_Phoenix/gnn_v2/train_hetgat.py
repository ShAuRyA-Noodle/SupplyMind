...
Usage:
    python -m ShAuRyA_Phoenix.gnn_v2.train_hetgat --graph easy --epochs 200
    python -m ShAuRyA_Phoenix.gnn_v2.train_hetgat --all
"""
...
OUT_DIR = REPO_ROOT / "ShAuRyA_Phoenix" / "experiments" / "hetgat_v1"
