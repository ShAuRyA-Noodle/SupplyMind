...
Usage:
    ...
    python -m ShAuRyA_Supplymind.realtime.ingestor --once

    # Continuous loop, 5-minute cycle
    python -m ShAuRyA_Supplymind.realtime.ingestor --interval 300

    # Lookback window (only affects newsapi + gdelt)
    python -m ShAuRyA_Supplymind.realtime.ingestor --once --lookback-min 240
