...
| # | Issue | Close | Commit |
|---|---|---|---|
| TG-1 | Krippendorff α claim 0.750 contradicts R4 JSON 0.2097 (ordinal) | README now shows 4 rows: mean_conf (0.750), α_local (0.210), α_combined (0.319 partial), majority-vote accuracy (0.615). All computed from real data by `scripts/compute_panel_agreement.py`, receipt at [tests/receipts/frontier_panel_alpha.json](../tests/receipts/frontier_panel_alpha.json). | `1567c53` |
